...
public class PngCreate {
	...
	public static void createTest1(String orig, int cols, int rows, int bitspc, int channels)
		...
		PngWriter i2 = FileHelper.createPngWriter(new File(orig), new ImageInfo(cols, rows,
				bitspc, channels == 4), true);
		makeTestImage(i2);
	...
	public static void main2(String[] args) throws Exception {
		if (args.length < 5) {
			...
			System.err
					.println("type : 0: gray opaque image  1=test image with colors (default) ");
			System.exit(1);
		}
