...
public class ChunkSequenceSkipTest {
	...
	public void testReadWithExtraTrailing() throws Exception {
		ChunkSequenceSkip c = new ChunkSequenceSkip();
		TestSupport.feedFromStreamTest(c, "resources/test/stripes_extratrailing.png",-1);
		TestCase.assertEquals(6785, c.getBytesCount());
		TestCase.assertEquals(
				stripesChunks,
				TestSupport.showChunksRaw(c.getChunks()));
	}
	...
	public void testReadIncomplete() throws Exception {
		...
		ChunkSequenceSkip c = new ChunkSequenceSkip();
		TestSupport.feedFromStreamTest(c, "resources/test/bad_truncated.png");
