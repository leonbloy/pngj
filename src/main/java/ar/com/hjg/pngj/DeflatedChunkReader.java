...
/**
 * 
 * Specialization of ChunkReader, for IDAT-like chunks. These chunks are part of a set of similar
 * chunks (contiguos normally, not necessariyl) which conforms a zlib stream
 */
