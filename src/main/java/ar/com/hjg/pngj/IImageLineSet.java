...
public interface IImageLineSet<T extends IImageLine> {
	 ...
	 * effects in this object (eg, advance a cursor, set current row number...) In some scenarios, this should be
	 * consider as alias to (pseudocode) <tt>positionAtLine(n); getCurrentLine();</tt>
	 * <p>
