...
public class IdatSet extends DeflatedChunksSet {
	 ...
	 * <p>
	 * <p>
	 * Same as {@link #IdatSet(String, ImageInfo, Deinterlacer)}, but you can pass a Inflater (will be reset
	 * internally), and a buffer (will be used only if size is enough)
	 */
