...
public interface IImageLine {
	...
	/**
	 * This is called when the read for the line has been completed (eg for interlaced). It's called exactly once for
	 * each line. This is provided in case the class needs to to some postprocessing.
	 */
