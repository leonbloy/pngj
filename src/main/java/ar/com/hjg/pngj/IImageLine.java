 ...
 * <p>
 * The user of this library will not normally use this methods, but instead will cast to a more concrete implementation, as {@link ImageLineInt} or {@link ImageLineByte} with its
 * methods for accessing the pixel values.
 */
public interface IImageLine {
  ...
  /**
   * This is called when the read for the line has been completed (eg for interlaced). It's called exactly once for each line. This is provided in case the class needs to to some
   * postprocessing.
   */
