...
/**
 * This estimator actually uses the LZ4 compression algorithm, and hopes that it's well correlated
 * with Deflater. It's about 3 to 4 times faster than Deflater.
 * 
 * This is a modified heavily trimmed version of the net.jpountz.lz4.LZ4JavaSafeCompressor class
 * plus some methods from other classes from LZ4 Java library: https://github.com/jpountz/lz4-java ,
