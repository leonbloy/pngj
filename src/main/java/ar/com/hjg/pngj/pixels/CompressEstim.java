...
public class CompressEstim {
   ...
   * 
   * This is one-shot (not dependent on previous history). For small values (less than MINLEN)
   * returns 1.0 For large values (more than 64K) it might consider only the first 64K
   * 
   * @param buf
   * @param offset
   * @param len
