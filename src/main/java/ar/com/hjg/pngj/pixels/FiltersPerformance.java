...
public class FiltersPerformance {
  ...
  /**
   * Values greater than 1.0 (towards infinite) increase the memory towards 1. Values smaller than
   * 1.0 (towards zero) decreases the memory .
   * 
   */
  ...
  /**
   * To set manually the filter weights. This is not recommended, unless you know what you are
   * doing. Setting this ignores preferenceForNone and omits some heuristics
   * 
