...
/**
 * Represents an image line, integer format (one integer by sample). See {@link #scanline} to
...
public class ImageLineInt implements IImageLine, IImageLineArray {
   ...
   * <p>
   * Each <code>int</code> is a "sample" (one for channel), (0-255 or 0-65535) in the corresponding
   * PNG sequence: <code>R G B R G B...</code> or <code>R G B A R G B A...</tt> 
