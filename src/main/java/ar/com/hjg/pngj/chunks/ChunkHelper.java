...
public class ChunkHelper {
	...
	/**
	 * Adhoc criteria: two ancillary chunks are "equivalent" ("practically same type") if they have same id and
	 * (perhaps, if multiple are allowed) if the match also in some "internal key" (eg: key for string values, palette
	 * for sPLT, etc)
	 * 
