...
public class RemoveChunksNgTest {
	...
	public void test1() throws Exception {
		...
		TestCase.assertEquals(
				"IHDR[13] pHYs[9] tEXt[19] IDAT[2000] IDAT[2000] IDAT[2000] IDAT[610] tIME[7] tEXt[18] IEND[0] ", oric);
		TestCase.assertEquals("IHDR[13] pHYs[9] IDAT[2000] IDAT[2000] IDAT[2000] IDAT[610] IEND[0] ", destc);
	}
