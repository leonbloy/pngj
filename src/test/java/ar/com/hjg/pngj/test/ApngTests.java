...
public class ApngTests {
	...
	public void readAsPng() {
		PngReaderByte ap = new PngReaderByte(TestSupport.absFile("test/apgn/clock_apng.png"));
	...
	public void readAsPngWithStill() {
		PngReaderByte ap = new PngReaderByte(TestSupport.absFile("test/apgn/withstill_apng.png"));
	...
	public void readBasicEqualSize() { // frames with equal size
		PngReaderApng ap = new PngReaderApng(TestSupport.absFile("test/apgn/loading_apng.png"));
	...
	public void readBasicDifferentSize() {
		PngReaderApng ap = new PngReaderApng(TestSupport.absFile("test/apgn/clock_apng.png"));
		TestCase.assertTrue("is apng", ap.isApng());
		TestCase.assertFalse("no still image", ap.hasExtraStillImage());
		int numf = ap.getApngNumFrames();
		...
		String row15_f12, row15_f13, row15_f14;
		{
			...
			PngReaderByte png12 = new PngReaderByte(TestSupport.absFile("test/apgn/apngf_012_clock_apng.png"));
			row15_f12 = TestSupport.showLine(png12.readRow(15));
			png12.end();
			PngReaderByte png13 = new PngReaderByte(TestSupport.absFile("test/apgn/apngf_013_clock_apng.png"));
			row15_f13 = TestSupport.showLine(png13.readRow(15));
			png13.end();
			PngReaderByte png14 = new PngReaderByte(TestSupport.absFile("test/apgn/apngf_014_clock_apng.png"));
		...
		for (int frame = 0; frame < numf; frame++) {
			...
			if (frame % 3 == 0) {
				...
				IImageLineSet<? extends IImageLine> lineset = ap.readRows(ap.getCurImgInfo().rows / 5, 3, 4);
	...
	public void readBasicWithStill() {
		PngReaderApng ap = new PngReaderApng(TestSupport.absFile("test/apgn/withstill_apng.png"));
		TestCase.assertTrue("is apng", ap.isApng());
