...
public class CreateGray {
	...
	String name = String.format("%s%02d", (channels > 2 ? "RGB" : "G") + (imi.alpha ? "A" : ""), bitdepth)
		.toLowerCase();
	String desc = String.format("Gray in %s format, bitdepth=%d. ",
		(channels > 2 ? "RGB" : "G") + (imi.alpha ? "A" : ""), bitdepth);
