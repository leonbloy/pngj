...
public class ImageIoUtils {
	...
	public static void writePng(OutputStream os, BufferedImage bi, boolean preferBetter) throws IOException {
	...
	// returns [R G B A R G B A ...] one int per sample (it really could fit in
	// byte[] but we assume that does not matter
	// here)
