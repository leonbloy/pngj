...
public class DetectDuplicates {
	...
	public static void run(String[] args) {
		...
		help.append("  Options:   \n");
		help.append("    -r: rename duplicates preppending '" + REMOVE__DUP__PNG_ + "' to the filename\n");
		...
		help.append(
				"  Accepts list of files and/or paths in the form 'mypath/*' (all pngs in dir) or 'mypath/**' (idem recursive)  \n");
