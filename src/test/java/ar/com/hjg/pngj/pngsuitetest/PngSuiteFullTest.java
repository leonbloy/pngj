...
public class PngSuiteFullTest {
	...
	try {
	    ...
	    try (FileInputStream sx = new FileInputStream(sourceFile);
		    FileChannel source = sx.getChannel();
		    FileOutputStream sox = new FileOutputStream(destFile);
		    FileChannel destination = sox.getChannel()) {
